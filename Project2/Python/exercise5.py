...
def exercise5():
    ...
    pars = SimulationParameters(
        ...
        video_fps=50,
        cpg_frequency_gain=1.0,
        cpg_frequency_offset=0.0,
        drive=1.0,
        weights_body2body=1.0,
        weights_body2body_contralateral=1.0,
        phase_lag_body=2*np.pi,
        amplitude_rates=1.0,
        nominal_amplitude=np.ones(2*13),
        feedback_weights_ipsi=1.0,
        feedback_weights_contra=-1.0,
        feedback_gain_ref=1.0,
