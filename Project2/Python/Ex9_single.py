...
ws_ref = define_hyperparameters()["ws_ref"]
def exercise9():
    pylog.info("Ex 9: No CPG test")
    ...
    pars = SimulationParameters(
        n_iterations=20001,             # 10 s @ 0.001 s timestep
        timestep=0.001,
        n_joints=13,
        ...
        headless=False,
        video_record=True,
        video_name='exercise9_cpg_swim_No_Body2Body',
        video_fps=60,
    ...
    pylog.info("W_body2body: {}".format(pars.weights_body2body))
    pylog.info("W_body2body_contralateral: {}".format(pars.weights_body2body_contralateral))
